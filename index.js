...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TreeNode = __webpack_require__(35);
	...
	var TreeView = function (_Component) {
	    ...
	    function TreeView(props) {
	        ...
	        var data = (0, _utilities.mapTree)(props.data, function (d) {
	            if (d.expanded !== true) {
	    ...
	    _createClass(TreeView, [{
	        ...
	        value: function handleCheck(e) {
	            var newState = _lodash2.default.clone(this.state.data);
	            var node = (0, _utilities.findNodeById)(newState, parseInt(e.target.dataset.id, 10));
	        ...
	        value: function handleDoubleClick(e) {
	            ...
	            var node = (0, _utilities.findNodeById)(newState, parseInt(e.target.dataset.id, 10));
	            if (node.expanded) {
	                (0, _utilities.collapseBranchChildren)(node);
	            } else {
	                (0, _utilities.expandBranchChildren)(node);
	            }
	            this.setState({ data: newState });
	        ...
	        value: function handleToggleClick(e) {
	            ...
	            var node = (0, _utilities.findNodeById)(newState, parseInt(e.target.dataset.id, 10));
	            if (node.expanded) {
	                (0, _utilities.collapseBranch)(node);
	            } else {
	                (0, _utilities.expandBranch)(node);
	            }
	            this.setState({ data: newState });
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                data.map(function (d, i) {
	                    return _react2.default.createElement(_TreeNode2.default, _extends({
	                        key: d.id,
	                        data: d,
	                        handleSelect: _this2.handleSelect.bind(_this2),
	                        handleToggleClick: _this2.handleToggleClick.bind(_this2),
	                        handleDoubleClick: _this2.handleDoubleClick.bind(_this2),
	                        handleCheck: _this2.handleCheck.bind(_this2),
	                        level: 0,
	                        'data-expanded': d.expanded
	                    }, (0, _utilities.passDownProps)(_this2.props)));
	                })
	            );
	        }
	    }]);
	...
	TreeView.propTypes = {
	    ...
	    onExpandAll: _react.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TreeNodeAnchor = __webpack_require__(39);

	var _TreeNodeAnchor2 = _interopRequireDefault(_TreeNodeAnchor);
	...
	var TreeNode = function (_Component) {
	    ...
	    _createClass(TreeNode, [{
	        key: 'getNodeSelector',
	        value: function getNodeSelector(child) {
	            var _props = this.props;
	            var data = _props.data;
	            var handleDoubleClick = _props.handleDoubleClick;

	            return _react2.default.createElement(
	                _TreeNodeAnchor2.default,
	                {
	                    'data-id': data.id,
	        ...
	        key: 'getNodeExpander',
	        value: function getNodeExpander(child) {
	            var _props2 = this.props;
	            var data = _props2.data;
	            var handleToggleClick = _props2.handleToggleClick;
	            var handleDoubleClick = _props2.handleDoubleClick;
	        ...
	        value: function getCheckbox(data) {
	            return this.props.checkable ? _react2.default.createElement('input', {
	                'data-id': data.id,
	                type: 'checkbox',
	        ...
	        value: function getCollapsedIcon() {
	            var icon = this.props.collapsedIcon;
	            return icon ? icon : 'plus-square-o';
	        }
	    }, {
	        key: 'getExpandedIcon',
	        value: function getExpandedIcon() {
	            var icon = this.props.expandedIcon;
	        ...
	        value: function render() {
	            ...
	            var newLevel = level++;
	            var hasChildren = data.children !== undefined || data._children !== undefined;
	            return _react2.default.createElement(
	                'li',
	                { style: { marginLeft: hasChildren ? level * 15 + 'px' : level * 15 + 15 + 'px' } },
	                hasChildren ? _react2.default.createElement(
	                    'div',
	                    null,
	                    this.getNodeExpander(_react2.default.createElement(_reactFontawesome2.default, {
	                        'data-id': data.id,
	                        name: expanded ? this.getExpandedIcon() : this.getCollapsedIcon()
	                    })),
	                    this.getCheckbox(data),
	                    this.getIcon(),
	                    this.props.selectable ? this.getNodeSelector(text) : this.getNodeExpander(text)
	                ...
	                data.children !== undefined ? _react2.default.createElement(
	                    'ul',
	                    { className: 'tree-branch', key: _lodash2.default.uniqueId() },
	...
	TreeNode.propTypes = {
	    ...
	    onDrag: _react.PropTypes.func,
	    onDragEnd: _react.PropTypes.func,
	    handleToggleClick: _react.PropTypes.func,
	    handleDoubleClick: _react.PropTypes.func
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TreeNodeAnchor = function (_Component) {
	    _inherits(TreeNodeAnchor, _Component);

	    function TreeNodeAnchor() {
	        _classCallCheck(this, TreeNodeAnchor);

	        return _possibleConstructorReturn(this, (TreeNodeAnchor.__proto__ || Object.getPrototypeOf(TreeNodeAnchor)).apply(this, arguments));
	    }

	    _createClass(TreeNodeAnchor, [{
	        key: 'render',
	        value: function render() {
	            var _props = this.props;
	            var id = _props.id;
	            ...
	            return _react2.default.createElement(
	                ...
	                }, (0, _utilities.passDownProps)(this.props)),
	                children
	            );
	        }
	    }]);

	    return TreeNodeAnchor;
	}(_react.Component);
	...
	exports.default = TreeNodeAnchor;
...
/***/ function(module, exports) {
	...
	var passDownProps = exports.passDownProps = function passDownProps(_ref) {
	    var data = _ref.data;
	    var level = _ref.level;
	    var expanded = _ref.expanded;
	    var className = _ref.className;

	    var rest = _objectWithoutProperties(_ref, ["data", "level", "expanded", "className"]);

	    return rest;
	};
	var domProps = exports.domProps = function domProps(_ref2) {
	    var data = _ref2.data;
	    var level = _ref2.level;
	    var expanded = _ref2.expanded;
	    var handleToggleClick = _ref2.handleToggleClick;
	    var handleDoubleClick = _ref2.handleDoubleClick;
	    var handleCheck = _ref2.handleCheck;
	    var onExpand = _ref2.onExpand;
	    var draggable = _ref2.draggable;
	    var selectable = _ref2.selectable;
	    var onDragStart = _ref2.onDragStart;
	    var onDrag = _ref2.onDrag;
	    var onDragEnd = _ref2.onDragEnd;
	    var checkable = _ref2.checkable;
	    var onCheck = _ref2.onCheck;
	    var handleSelect = _ref2.handleSelect;

	    var rest = _objectWithoutProperties(_ref2, ["data", "level", "expanded", "handleToggleClick", "handleDoubleClick", "handleCheck", "onExpand", "draggable", "selectable", "onDragStart", "onDrag", "onDragEnd", "checkable", "onCheck", "handleSelect"]);

	    return rest;
	};
	var mapTree = exports.mapTree = function mapTree(root, callback) {
	...
	var collapseBranch = exports.collapseBranch = function collapseBranch(node) {
	    node.expanded = false;
	    node._children = node.children;
	    node.children = [];
	};
	var collapseBranchChildren = exports.collapseBranchChildren = function collapseBranchChildren(node) {
	    if (node.children) {
	        collapseBranch(node);
	        node._children.forEach(function (c) {
	            return collapseBranchChildren(c);
	        });
	    }
	};
	var expandBranch = exports.expandBranch = function expandBranch(node) {
	    node.expanded = true;
	    node.children = node._children;
	    node._children = undefined;
	};
	var expandBranchChildren = exports.expandBranchChildren = function expandBranchChildren(node) {
	    if (node._children) {
	        expandBranch(node);
	        node.children.forEach(function (c) {
	            return expandBranchChildren(c);
	        });
	    }
	};
